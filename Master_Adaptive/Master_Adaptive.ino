...
void loop() {
  ...
  if (TRIAL_RUNNING){
    ...
    if (currentTime >= windowEnds){
        ...
        met.scheduleNext(currAsynch, slaveIsConnected, GEM_MAX_SLAVES, GEM_METRONOME_HEURISTIC_AVERAGE);
