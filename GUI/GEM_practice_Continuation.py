...
presets = {
    ...
    # below are modifications to the original practice run to create a new practice run for the continuation task. 
    "metronome_continuation": 1,
    "metronome_prompt_windows": 4,
    "metronome_stop_window": 26 
}
