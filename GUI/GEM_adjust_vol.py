...
presets = {
    ...
    # number of players in the experiment. NB: all 4 slaves Arduinos should still be attached to master
    "slaves_requested": 1, # don't care about participant IDs since this is just for adjusting volume
